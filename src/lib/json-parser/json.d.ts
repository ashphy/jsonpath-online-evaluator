...
export type StartRuleNames = "JSON_text";
export interface ParseOptions<T extends StartRuleNames = "JSON_text"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"JSON_text">>(
  input: string,
  options?: Options,
): any;
